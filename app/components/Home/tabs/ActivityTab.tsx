...
const ActivityTab: React.FC<TabProps> = ({ toons }) => {
      ...
      <div className="flex flex-row space-x-2">
        <div className="activity-container">
          <div className="activity-header-container">
            ...
            <div className="activity-header trophy-total">
              {trophyIcon(getGolfTrophies(toons))}
            </div>
          </div>
          {toons.data.golf ? (
            renderStats(toons.data.golf, golf_trophies)
          ) : (
        ...
        <div className="activity-container">
          <div className="activity-header-container">
            ...
            <div className="activity-header trophy-total">
              {trophyIcon(getRaceTrophies(toons))}
            </div>
          </div>
          {toons.data.racing ? (
            renderStats(toons.data.racing, race_trophies)
          ) : (
