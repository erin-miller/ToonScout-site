...
const InfoTab: React.FC<TabProps> = ({ toons, setSelectedTab }) => {
    ...
    <AnimatedTabContent>
      ...
      {hasNoSuit(toons) ? (
        ...
        <div className="suits-info-container">
          <div className="suit-card">{displaySuit(toons, "s")}</div>
          <div className="suit-card">{displaySuit(toons, "m")}</div>
          <div className="suit-card">{displaySuit(toons, "l")}</div>
          <div className="suit-card">{displaySuit(toons, "c")}</div>
        </div>
      )}
    </AnimatedTabContent>
  );
